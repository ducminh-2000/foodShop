...
<form action="" method="GET">
    ...
    <div class="form-group">
        <label for="title">Chọn danh mục sản phẩm</label>
            ...
            <tr>
                ...
                <td>
                    <?php if (!empty($product['avatar'])): ?>
                        <img height="" src="assets/uploads/<?php echo $product['avatar'] ?>" style="border-radius:0% !important;width:80%;height:40px"/>
                    <?php endif; ?>
                </td>
